...
public static void main(String[] args) {
		...
		QualitativeAllenIntervalConstraint con0 = new QualitativeAllenIntervalConstraint(QualitativeAllenIntervalConstraint.Type.Before);
		con0.setFrom(re0);
		con0.setTo(re1);
//		System.out.println("Adding constraint " + con0 + ": " + solver.addConstraint(con0));
		
		QualitativeAllenIntervalConstraint con1 = new QualitativeAllenIntervalConstraint(QualitativeAllenIntervalConstraint.Type.Before);
		con1.setFrom(re1);
		con1.setTo(re2);
//		System.out.println("Adding constraint " + con1 + ": " + solver.addConstraint(con1));
		
		QualitativeAllenIntervalConstraint con2 = new QualitativeAllenIntervalConstraint(QualitativeAllenIntervalConstraint.Type.Before);
		con2.setFrom(re2);
		con2.setTo(re0);
