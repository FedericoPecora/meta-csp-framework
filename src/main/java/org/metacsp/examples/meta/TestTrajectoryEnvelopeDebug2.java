...
public class TestTrajectoryEnvelopeDebug2 {
	...
	public static void main(String[] args) {
		...
		TrajectoryEnvelope var6 = (TrajectoryEnvelope)vars[6];
		...
		Trajectory traj6 = new Trajectory("paths/debugPaths/test0_1.path");
		var6.setFootprint(backLeft,backRight,frontLeft,frontRight);
		var6.setTrajectory(traj6);
		var6.setRobotID(2);
		...
		tea.addTrajectoryEnvelopes(var0,var1,var2,var3,var4,var5,var6);
