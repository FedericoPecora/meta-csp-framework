...
public class TestSpatioTemporalVariableSolverEquals {
	...
	public static void main(String[] args) {
		...
		//1
		var1.setDomain(new PolygonalDomain(var1,new Coordinate[] {
				new Coordinate(0,0),
				new Coordinate(10,0),
				new Coordinate(10,10),
				new Coordinate(0,10)
		...
		System.out.println(Arrays.toString(((DE9IMRelationSolver)solver.getConstraintSolvers()[1]).getAllImplicitRCC8Relations()));
