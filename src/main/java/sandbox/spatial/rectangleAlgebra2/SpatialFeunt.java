...
public class SpatialFeunt extends MultiVariable{
	...
	protected SpatialFeunt(ConstraintSolver cs, int id, ConstraintSolver[] internalSolvers) {
	...
	protected Variable[] createInternalVariables() {
		...
		Activity activityVariable= (Activity)internalSolvers[1].createVariable(component);
